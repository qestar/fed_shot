...
# 计算每个类的原型
def compute_class_prototypes(features, num):
    class_prototypes = []
    for class_id in range(num):
        class_features = features[class_id*10:10+class_id*10]
        class_prototype = class_features.mean(dim=0)  # 计算均值作为类原型
